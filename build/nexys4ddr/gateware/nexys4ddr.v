//--------------------------------------------------------------------------------
// Auto-generated by Migen (a5cc037) & LiteX (5097b7ae) on 2020-12-11 20:15:01
//--------------------------------------------------------------------------------
module nexys4ddr(
...
wire [7:0] basesoc_infrarrojo_cntrl_distancia_status;
wire basesoc_infrarrojo_cntrl_distancia_we;
wire basesoc_infrarrojo_cntrl_distancia_re;
wire basesoc_infrarrojo_cntrl_irq;
wire basesoc_infrarrojo_cntrl_ok_status;
reg basesoc_infrarrojo_cntrl_ok_pending = 1'd0;
reg basesoc_infrarrojo_cntrl_ok_trigger = 1'd0;
reg basesoc_infrarrojo_cntrl_ok_clear = 1'd0;
reg basesoc_infrarrojo_cntrl_ok_old_trigger = 1'd0;
wire basesoc_infrarrojo_cntrl_eventmanager_status_re;
wire basesoc_infrarrojo_cntrl_eventmanager_status_r;
wire basesoc_infrarrojo_cntrl_eventmanager_status_we;
wire basesoc_infrarrojo_cntrl_eventmanager_status_w;
wire basesoc_infrarrojo_cntrl_eventmanager_pending_re;
wire basesoc_infrarrojo_cntrl_eventmanager_pending_r;
wire basesoc_infrarrojo_cntrl_eventmanager_pending_we;
wire basesoc_infrarrojo_cntrl_eventmanager_pending_w;
reg basesoc_infrarrojo_cntrl_eventmanager_storage = 1'd0;
reg basesoc_infrarrojo_cntrl_eventmanager_re = 1'd0;
...
wire builder_csrbank4_distancia_re;
wire [7:0] builder_csrbank4_distancia_r;
wire builder_csrbank4_distancia_we;
wire [7:0] builder_csrbank4_distancia_w;
...
wire builder_csrbank7_out0_re;
wire [9:0] builder_csrbank7_out0_r;
wire builder_csrbank7_out0_we;
...
wire builder_csrbank8_orden0_re;
wire [2:0] builder_csrbank8_orden0_r;
wire builder_csrbank8_orden0_we;
wire [2:0] builder_csrbank8_orden0_w;
...
wire builder_csrbank9_in_re;
wire [7:0] builder_csrbank9_in_r;
wire builder_csrbank9_in_we;
...
wire builder_csrbank10_load0_re;
wire [31:0] builder_csrbank10_load0_r;
wire builder_csrbank10_load0_we;
wire [31:0] builder_csrbank10_load0_w;
wire builder_csrbank10_reload0_re;
wire [31:0] builder_csrbank10_reload0_r;
wire builder_csrbank10_reload0_we;
wire [31:0] builder_csrbank10_reload0_w;
wire builder_csrbank10_en0_re;
wire builder_csrbank10_en0_r;
wire builder_csrbank10_en0_we;
wire builder_csrbank10_en0_w;
wire builder_csrbank10_update_value0_re;
wire builder_csrbank10_update_value0_r;
wire builder_csrbank10_update_value0_we;
wire builder_csrbank10_update_value0_w;
wire builder_csrbank10_value_re;
wire [31:0] builder_csrbank10_value_r;
wire builder_csrbank10_value_we;
...
always @(*) begin
	...
	basesoc_basesoc_picorv32_interrupt[3] <= basesoc_infrarrojo_cntrl_irq;
...
assign basesoc_infrarrojo_cntrl_eventmanager_status_w = basesoc_infrarrojo_cntrl_ok_status;
always @(*) begin
	basesoc_infrarrojo_cntrl_ok_clear <= 1'd0;
	if ((basesoc_infrarrojo_cntrl_eventmanager_pending_re & basesoc_infrarrojo_cntrl_eventmanager_pending_r)) begin
		basesoc_infrarrojo_cntrl_ok_clear <= 1'd1;
	end
end
assign basesoc_infrarrojo_cntrl_eventmanager_pending_w = basesoc_infrarrojo_cntrl_ok_pending;
assign basesoc_infrarrojo_cntrl_irq = (basesoc_infrarrojo_cntrl_eventmanager_pending_w & basesoc_infrarrojo_cntrl_eventmanager_storage);
assign basesoc_infrarrojo_cntrl_ok_status = basesoc_infrarrojo_cntrl_ok_trigger;
always @(*) begin
...
assign builder_csrbank4_sel = (builder_interface4_bank_bus_adr[13:9] == 4'd13);
assign builder_csrbank4_distancia_r = builder_interface4_bank_bus_dat_w[7:0];
assign builder_csrbank4_distancia_re = ((builder_csrbank4_sel & builder_interface4_bank_bus_we) & (builder_interface4_bank_bus_adr[1:0] == 1'd0));
assign builder_csrbank4_distancia_we = ((builder_csrbank4_sel & (~builder_interface4_bank_bus_we)) & (builder_interface4_bank_bus_adr[1:0] == 1'd0));
assign basesoc_infrarrojo_cntrl_eventmanager_status_r = builder_interface4_bank_bus_dat_w[0];
assign basesoc_infrarrojo_cntrl_eventmanager_status_re = ((builder_csrbank4_sel & builder_interface4_bank_bus_we) & (builder_interface4_bank_bus_adr[1:0] == 1'd1));
assign basesoc_infrarrojo_cntrl_eventmanager_status_we = ((builder_csrbank4_sel & (~builder_interface4_bank_bus_we)) & (builder_interface4_bank_bus_adr[1:0] == 1'd1));
assign basesoc_infrarrojo_cntrl_eventmanager_pending_r = builder_interface4_bank_bus_dat_w[0];
assign basesoc_infrarrojo_cntrl_eventmanager_pending_re = ((builder_csrbank4_sel & builder_interface4_bank_bus_we) & (builder_interface4_bank_bus_adr[1:0] == 2'd2));
assign basesoc_infrarrojo_cntrl_eventmanager_pending_we = ((builder_csrbank4_sel & (~builder_interface4_bank_bus_we)) & (builder_interface4_bank_bus_adr[1:0] == 2'd2));
assign builder_csrbank4_ev_enable0_r = builder_interface4_bank_bus_dat_w[0];
assign builder_csrbank4_ev_enable0_re = ((builder_csrbank4_sel & builder_interface4_bank_bus_we) & (builder_interface4_bank_bus_adr[1:0] == 2'd3));
assign builder_csrbank4_ev_enable0_we = ((builder_csrbank4_sel & (~builder_interface4_bank_bus_we)) & (builder_interface4_bank_bus_adr[1:0] == 2'd3));
assign builder_csrbank4_distancia_w = basesoc_infrarrojo_cntrl_distancia_status[7:0];
assign basesoc_infrarrojo_cntrl_distancia_we = builder_csrbank4_distancia_we;
assign basesoc_infrarrojo_cntrl_distancia_re = builder_csrbank4_distancia_re;
assign builder_csrbank4_ev_enable0_w = basesoc_infrarrojo_cntrl_eventmanager_storage;
assign builder_csrbank5_sel = (builder_interface5_bank_bus_adr[13:9] == 4'd9);
...
assign builder_csrbank6_sel = (builder_interface6_bank_bus_adr[13:9] == 4'd10);
assign builder_csrbank6_r_enable0_r = builder_interface6_bank_bus_dat_w[0];
assign builder_csrbank6_r_enable0_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[3:0] == 1'd0));
assign builder_csrbank6_r_enable0_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[3:0] == 1'd0));
assign builder_csrbank6_r_width0_r = builder_interface6_bank_bus_dat_w[31:0];
assign builder_csrbank6_r_width0_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[3:0] == 1'd1));
assign builder_csrbank6_r_width0_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[3:0] == 1'd1));
assign builder_csrbank6_r_period0_r = builder_interface6_bank_bus_dat_w[31:0];
assign builder_csrbank6_r_period0_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[3:0] == 2'd2));
assign builder_csrbank6_r_period0_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[3:0] == 2'd2));
assign builder_csrbank6_g_enable0_r = builder_interface6_bank_bus_dat_w[0];
assign builder_csrbank6_g_enable0_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[3:0] == 2'd3));
assign builder_csrbank6_g_enable0_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[3:0] == 2'd3));
assign builder_csrbank6_g_width0_r = builder_interface6_bank_bus_dat_w[31:0];
assign builder_csrbank6_g_width0_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[3:0] == 3'd4));
assign builder_csrbank6_g_width0_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[3:0] == 3'd4));
assign builder_csrbank6_g_period0_r = builder_interface6_bank_bus_dat_w[31:0];
assign builder_csrbank6_g_period0_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[3:0] == 3'd5));
assign builder_csrbank6_g_period0_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[3:0] == 3'd5));
assign builder_csrbank6_b_enable0_r = builder_interface6_bank_bus_dat_w[0];
assign builder_csrbank6_b_enable0_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[3:0] == 3'd6));
assign builder_csrbank6_b_enable0_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[3:0] == 3'd6));
assign builder_csrbank6_b_width0_r = builder_interface6_bank_bus_dat_w[31:0];
assign builder_csrbank6_b_width0_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[3:0] == 3'd7));
assign builder_csrbank6_b_width0_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[3:0] == 3'd7));
assign builder_csrbank6_b_period0_r = builder_interface6_bank_bus_dat_w[31:0];
assign builder_csrbank6_b_period0_re = ((builder_csrbank6_sel & builder_interface6_bank_bus_we) & (builder_interface6_bank_bus_adr[3:0] == 4'd8));
assign builder_csrbank6_b_period0_we = ((builder_csrbank6_sel & (~builder_interface6_bank_bus_we)) & (builder_interface6_bank_bus_adr[3:0] == 4'd8));
...
assign builder_csrbank7_out0_re = ((builder_csrbank7_sel & builder_interface7_bank_bus_we) & (builder_interface7_bank_bus_adr[0] == 1'd0));
assign builder_csrbank7_out0_we = ((builder_csrbank7_sel & (~builder_interface7_bank_bus_we)) & (builder_interface7_bank_bus_adr[0] == 1'd0));
assign builder_csrbank7_out0_w = basesoc_leds_storage[9:0];
assign builder_csrbank8_sel = (builder_interface8_bank_bus_adr[13:9] == 4'd14);
assign builder_csrbank8_orden0_r = builder_interface8_bank_bus_dat_w[2:0];
assign builder_csrbank8_orden0_re = ((builder_csrbank8_sel & builder_interface8_bank_bus_we) & (builder_interface8_bank_bus_adr[0] == 1'd0));
assign builder_csrbank8_orden0_we = ((builder_csrbank8_sel & (~builder_interface8_bank_bus_we)) & (builder_interface8_bank_bus_adr[0] == 1'd0));
assign builder_csrbank8_orden0_w = basesoc_pwm_cntrl_storage[2:0];
assign builder_csrbank9_sel = (builder_interface9_bank_bus_adr[13:9] == 3'd6);
assign builder_csrbank9_in_r = builder_interface9_bank_bus_dat_w[7:0];
assign builder_csrbank9_in_re = ((builder_csrbank9_sel & builder_interface9_bank_bus_we) & (builder_interface9_bank_bus_adr[0] == 1'd0));
assign builder_csrbank9_in_we = ((builder_csrbank9_sel & (~builder_interface9_bank_bus_we)) & (builder_interface9_bank_bus_adr[0] == 1'd0));
assign builder_csrbank9_in_w = basesoc_switchs_status[7:0];
assign basesoc_switchs_we = builder_csrbank9_in_we;
assign basesoc_switchs_re = builder_csrbank9_in_re;
assign builder_csrbank10_sel = (builder_interface10_bank_bus_adr[13:9] == 3'd4);
assign builder_csrbank10_load0_r = builder_interface10_bank_bus_dat_w[31:0];
assign builder_csrbank10_load0_re = ((builder_csrbank10_sel & builder_interface10_bank_bus_we) & (builder_interface10_bank_bus_adr[2:0] == 1'd0));
assign builder_csrbank10_load0_we = ((builder_csrbank10_sel & (~builder_interface10_bank_bus_we)) & (builder_interface10_bank_bus_adr[2:0] == 1'd0));
assign builder_csrbank10_reload0_r = builder_interface10_bank_bus_dat_w[31:0];
assign builder_csrbank10_reload0_re = ((builder_csrbank10_sel & builder_interface10_bank_bus_we) & (builder_interface10_bank_bus_adr[2:0] == 1'd1));
assign builder_csrbank10_reload0_we = ((builder_csrbank10_sel & (~builder_interface10_bank_bus_we)) & (builder_interface10_bank_bus_adr[2:0] == 1'd1));
assign builder_csrbank10_en0_r = builder_interface10_bank_bus_dat_w[0];
assign builder_csrbank10_en0_re = ((builder_csrbank10_sel & builder_interface10_bank_bus_we) & (builder_interface10_bank_bus_adr[2:0] == 2'd2));
assign builder_csrbank10_en0_we = ((builder_csrbank10_sel & (~builder_interface10_bank_bus_we)) & (builder_interface10_bank_bus_adr[2:0] == 2'd2));
assign builder_csrbank10_update_value0_r = builder_interface10_bank_bus_dat_w[0];
assign builder_csrbank10_update_value0_re = ((builder_csrbank10_sel & builder_interface10_bank_bus_we) & (builder_interface10_bank_bus_adr[2:0] == 2'd3));
assign builder_csrbank10_update_value0_we = ((builder_csrbank10_sel & (~builder_interface10_bank_bus_we)) & (builder_interface10_bank_bus_adr[2:0] == 2'd3));
assign builder_csrbank10_value_r = builder_interface10_bank_bus_dat_w[31:0];
assign builder_csrbank10_value_re = ((builder_csrbank10_sel & builder_interface10_bank_bus_we) & (builder_interface10_bank_bus_adr[2:0] == 3'd4));
assign builder_csrbank10_value_we = ((builder_csrbank10_sel & (~builder_interface10_bank_bus_we)) & (builder_interface10_bank_bus_adr[2:0] == 3'd4));
assign basesoc_basesoc_timer_eventmanager_status_r = builder_interface10_bank_bus_dat_w[0];
assign basesoc_basesoc_timer_eventmanager_status_re = ((builder_csrbank10_sel & builder_interface10_bank_bus_we) & (builder_interface10_bank_bus_adr[2:0] == 3'd5));
assign basesoc_basesoc_timer_eventmanager_status_we = ((builder_csrbank10_sel & (~builder_interface10_bank_bus_we)) & (builder_interface10_bank_bus_adr[2:0] == 3'd5));
assign basesoc_basesoc_timer_eventmanager_pending_r = builder_interface10_bank_bus_dat_w[0];
assign basesoc_basesoc_timer_eventmanager_pending_re = ((builder_csrbank10_sel & builder_interface10_bank_bus_we) & (builder_interface10_bank_bus_adr[2:0] == 3'd6));
assign basesoc_basesoc_timer_eventmanager_pending_we = ((builder_csrbank10_sel & (~builder_interface10_bank_bus_we)) & (builder_interface10_bank_bus_adr[2:0] == 3'd6));
assign builder_csrbank10_ev_enable0_r = builder_interface10_bank_bus_dat_w[0];
assign builder_csrbank10_ev_enable0_re = ((builder_csrbank10_sel & builder_interface10_bank_bus_we) & (builder_interface10_bank_bus_adr[2:0] == 3'd7));
assign builder_csrbank10_ev_enable0_we = ((builder_csrbank10_sel & (~builder_interface10_bank_bus_we)) & (builder_interface10_bank_bus_adr[2:0] == 3'd7));
...
assign basesoc_basesoc_timer_value_re = builder_csrbank10_value_re;
assign builder_csrbank10_ev_enable0_w = basesoc_basesoc_timer_eventmanager_storage;
assign builder_csrbank11_sel = (builder_interface11_bank_bus_adr[13:9] == 2'd3);
assign basesoc_basesoc_uart_rxtx_r = builder_interface11_bank_bus_dat_w[7:0];
assign basesoc_basesoc_uart_rxtx_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[2:0] == 1'd0));
assign basesoc_basesoc_uart_rxtx_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[2:0] == 1'd0));
...
assign basesoc_basesoc_uart_eventmanager_status_r = builder_interface11_bank_bus_dat_w[1:0];
assign basesoc_basesoc_uart_eventmanager_status_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[2:0] == 2'd3));
assign basesoc_basesoc_uart_eventmanager_status_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[2:0] == 2'd3));
assign basesoc_basesoc_uart_eventmanager_pending_r = builder_interface11_bank_bus_dat_w[1:0];
assign basesoc_basesoc_uart_eventmanager_pending_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[2:0] == 3'd4));
assign basesoc_basesoc_uart_eventmanager_pending_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[2:0] == 3'd4));
...
assign basesoc_basesoc_uart_txfull_re = builder_csrbank11_txfull_re;
...
assign basesoc_basesoc_uart_rxempty_re = builder_csrbank11_rxempty_re;
assign builder_csrbank11_ev_enable0_w = basesoc_basesoc_uart_eventmanager_storage[1:0];
...
assign basesoc_basesoc_uart_txempty_re = builder_csrbank11_txempty_re;
...
assign basesoc_basesoc_uart_rxfull_re = builder_csrbank11_rxfull_re;
...
always @(posedge sys_clk) begin
	...
	if (basesoc_infrarrojo_cntrl_ok_clear) begin
		basesoc_infrarrojo_cntrl_ok_pending <= 1'd0;
	end
	basesoc_infrarrojo_cntrl_ok_old_trigger <= basesoc_infrarrojo_cntrl_ok_trigger;
	if (((~basesoc_infrarrojo_cntrl_ok_trigger) & basesoc_infrarrojo_cntrl_ok_old_trigger)) begin
		basesoc_infrarrojo_cntrl_ok_pending <= 1'd1;
	end
	...
	if (builder_csrbank4_sel) begin
		case (builder_interface4_bank_bus_adr[1:0])
			1'd0: begin
				builder_interface4_bank_bus_dat_r <= builder_csrbank4_distancia_w;
			end
			1'd1: begin
				builder_interface4_bank_bus_dat_r <= basesoc_infrarrojo_cntrl_eventmanager_status_w;
			end
			2'd2: begin
				builder_interface4_bank_bus_dat_r <= basesoc_infrarrojo_cntrl_eventmanager_pending_w;
			end
			2'd3: begin
	...
	if (builder_csrbank4_ev_enable0_re) begin
		basesoc_infrarrojo_cntrl_eventmanager_storage <= builder_csrbank4_ev_enable0_r;
	end
	basesoc_infrarrojo_cntrl_eventmanager_re <= builder_csrbank4_ev_enable0_re;
	...
	if (builder_csrbank6_sel) begin
		case (builder_interface6_bank_bus_adr[3:0])
			1'd0: begin
	...
	if (builder_csrbank8_sel) begin
		case (builder_interface8_bank_bus_adr[0])
			1'd0: begin
				builder_interface8_bank_bus_dat_r <= builder_csrbank8_orden0_w;
			end
		endcase
	end
	if (builder_csrbank8_orden0_re) begin
		basesoc_pwm_cntrl_storage[2:0] <= builder_csrbank8_orden0_r;
	end
	basesoc_pwm_cntrl_re <= builder_csrbank8_orden0_re;
	...
	if (builder_csrbank10_sel) begin
		case (builder_interface10_bank_bus_adr[2:0])
			...
			3'd5: begin
				builder_interface10_bank_bus_dat_r <= basesoc_basesoc_timer_eventmanager_status_w;
			end
			3'd6: begin
				builder_interface10_bank_bus_dat_r <= basesoc_basesoc_timer_eventmanager_pending_w;
			end
			3'd7: begin
	...
	if (builder_csrbank10_ev_enable0_re) begin
		basesoc_basesoc_timer_eventmanager_storage <= builder_csrbank10_ev_enable0_r;
	end
	basesoc_basesoc_timer_eventmanager_re <= builder_csrbank10_ev_enable0_re;
	...
	if (builder_csrbank11_sel) begin
		case (builder_interface11_bank_bus_adr[2:0])
			...
			2'd3: begin
				builder_interface11_bank_bus_dat_r <= basesoc_basesoc_uart_eventmanager_status_w;
			end
			3'd4: begin
				builder_interface11_bank_bus_dat_r <= basesoc_basesoc_uart_eventmanager_pending_w;
			end
			3'd5: begin
	...
	if (builder_csrbank11_ev_enable0_re) begin
		basesoc_basesoc_uart_eventmanager_storage[1:0] <= builder_csrbank11_ev_enable0_r;
	end
	basesoc_basesoc_uart_eventmanager_re <= builder_csrbank11_ev_enable0_re;
	...
	if (sys_rst) begin
		...
		basesoc_infrarrojo_cntrl_ok_pending <= 1'd0;
		basesoc_infrarrojo_cntrl_ok_old_trigger <= 1'd0;
		basesoc_infrarrojo_cntrl_eventmanager_storage <= 1'd0;
		basesoc_infrarrojo_cntrl_eventmanager_re <= 1'd0;
...
modulo_ir modulo_ir(
	...
	.rst(sys_rst),
	.ir_io(ir_inout),
	.distancia(basesoc_infrarrojo_cntrl_distancia_status)
);
