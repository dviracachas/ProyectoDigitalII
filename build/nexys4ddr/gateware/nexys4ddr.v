//--------------------------------------------------------------------------------
// Auto-generated by Migen (a5cc037) & LiteX (5097b7ae) on 2020-12-16 13:25:30
//--------------------------------------------------------------------------------
module nexys4ddr(
...
wire [7:0] basesoc_infrarrojo_cntrl_status;
wire basesoc_infrarrojo_cntrl_we;
wire basesoc_infrarrojo_cntrl_re;
reg [2:0] basesoc_pwm_cntrl_storage = 3'd0;
reg basesoc_pwm_cntrl_re = 1'd0;
reg basesoc_orden_storage = 1'd0;
reg basesoc_orden_re = 1'd0;
wire basesoc_done_status;
wire basesoc_done_we;
wire basesoc_done_re;
wire [7:0] basesoc_d_status;
wire basesoc_d_we;
wire basesoc_d_re;
reg [31:0] basesoc_uart1_phy_storage = 32'd412316;
...
wire builder_csrbank1_reset0_re;
wire builder_csrbank1_reset0_r;
wire builder_csrbank1_reset0_we;
wire builder_csrbank1_reset0_w;
...
wire builder_csrbank1_bus_errors_re;
wire [31:0] builder_csrbank1_bus_errors_r;
wire builder_csrbank1_bus_errors_we;
...
wire builder_csrbank3_distancia_re;
wire [7:0] builder_csrbank3_distancia_r;
wire builder_csrbank3_distancia_we;
wire [7:0] builder_csrbank3_distancia_w;
...
wire builder_csrbank7_orden0_re;
wire [2:0] builder_csrbank7_orden0_r;
wire builder_csrbank7_orden0_we;
wire [2:0] builder_csrbank7_orden0_w;
...
wire builder_csrbank8_in_re;
wire [7:0] builder_csrbank8_in_r;
wire builder_csrbank8_in_we;
...
wire builder_csrbank9_load0_re;
wire [31:0] builder_csrbank9_load0_r;
wire builder_csrbank9_load0_we;
wire [31:0] builder_csrbank9_load0_w;
wire builder_csrbank9_reload0_re;
wire [31:0] builder_csrbank9_reload0_r;
wire builder_csrbank9_reload0_we;
wire [31:0] builder_csrbank9_reload0_w;
wire builder_csrbank9_en0_re;
wire builder_csrbank9_en0_r;
wire builder_csrbank9_en0_we;
wire builder_csrbank9_en0_w;
wire builder_csrbank9_update_value0_re;
wire builder_csrbank9_update_value0_r;
wire builder_csrbank9_update_value0_we;
wire builder_csrbank9_update_value0_w;
wire builder_csrbank9_value_re;
wire [31:0] builder_csrbank9_value_r;
wire builder_csrbank9_value_we;
...
wire builder_csrbank11_txfull_re;
wire builder_csrbank11_txfull_r;
wire builder_csrbank11_txfull_we;
wire builder_csrbank11_txfull_w;
wire builder_csrbank11_rxempty_re;
wire builder_csrbank11_rxempty_r;
wire builder_csrbank11_rxempty_we;
...
wire [31:0] builder_csrbank13_tuning_word0_r;
wire builder_csrbank13_tuning_word0_we;
wire [31:0] builder_csrbank13_tuning_word0_w;
...
wire builder_csrbank14_orden0_re;
wire builder_csrbank14_orden0_r;
wire builder_csrbank14_orden0_we;
wire builder_csrbank14_orden0_w;
wire builder_csrbank14_done_re;
wire builder_csrbank14_done_r;
wire builder_csrbank14_done_we;
wire builder_csrbank14_done_w;
wire builder_csrbank14_d_re;
wire [7:0] builder_csrbank14_d_r;
wire builder_csrbank14_d_we;
wire [7:0] builder_csrbank14_d_w;
...
wire builder_csrbank15_mem_adr0_re;
wire [18:0] builder_csrbank15_mem_adr0_r;
wire builder_csrbank15_mem_adr0_we;
wire [18:0] builder_csrbank15_mem_adr0_w;
wire builder_csrbank15_mem_we0_re;
wire builder_csrbank15_mem_we0_r;
wire builder_csrbank15_mem_we0_we;
wire builder_csrbank15_mem_we0_w;
wire builder_csrbank15_mem_data_w0_re;
wire [11:0] builder_csrbank15_mem_data_w0_r;
wire builder_csrbank15_mem_data_w0_we;
wire [11:0] builder_csrbank15_mem_data_w0_w;
wire builder_csrbank15_mem_data_r_re;
wire [11:0] builder_csrbank15_mem_data_r_r;
wire builder_csrbank15_mem_data_r_we;
...
always @(*) begin
	...
	basesoc_basesoc_picorv32_interrupt[2] <= basesoc_irq;
end
...
assign basesoc_uart_sink_valid = basesoc_uart1_phy_source_valid;
assign basesoc_uart1_phy_source_ready = basesoc_uart_sink_ready;
assign basesoc_uart_sink_first = basesoc_uart1_phy_source_first;
assign basesoc_uart_sink_last = basesoc_uart1_phy_source_last;
assign basesoc_uart_sink_payload_data = basesoc_uart1_phy_source_payload_data;
assign basesoc_uart1_phy_sink_valid = basesoc_uart_source_valid;
assign basesoc_uart_source_ready = basesoc_uart1_phy_sink_ready;
assign basesoc_uart1_phy_sink_first = basesoc_uart_source_first;
assign basesoc_uart1_phy_sink_last = basesoc_uart_source_last;
assign basesoc_uart1_phy_sink_payload_data = basesoc_uart_source_payload_data;
...
always @(*) begin
	basesoc_eventmanager_status_w <= 2'd0;
	basesoc_eventmanager_status_w[0] <= basesoc_tx_status;
	basesoc_eventmanager_status_w[1] <= basesoc_rx_status;
end
always @(*) begin
...
always @(*) begin
	basesoc_eventmanager_pending_w <= 2'd0;
	basesoc_eventmanager_pending_w[0] <= basesoc_tx_pending;
	basesoc_eventmanager_pending_w[1] <= basesoc_rx_pending;
end
assign basesoc_irq = ((basesoc_eventmanager_pending_w[0] & basesoc_eventmanager_storage[0]) | (basesoc_eventmanager_pending_w[1] & basesoc_eventmanager_storage[1]));
...
assign builder_csrbank1_reset0_r = builder_interface1_bank_bus_dat_w[0];
assign builder_csrbank1_reset0_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[1:0] == 1'd0));
assign builder_csrbank1_reset0_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[1:0] == 1'd0));
assign builder_csrbank1_scratch0_r = builder_interface1_bank_bus_dat_w[31:0];
assign builder_csrbank1_scratch0_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[1:0] == 1'd1));
assign builder_csrbank1_scratch0_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[1:0] == 1'd1));
assign builder_csrbank1_bus_errors_r = builder_interface1_bank_bus_dat_w[31:0];
assign builder_csrbank1_bus_errors_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[1:0] == 2'd2));
assign builder_csrbank1_bus_errors_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[1:0] == 2'd2));
assign builder_csrbank1_reset0_w = basesoc_basesoc_soccontroller_reset_storage;
assign builder_csrbank1_scratch0_w = basesoc_basesoc_soccontroller_scratch_storage[31:0];
assign builder_csrbank1_bus_errors_w = basesoc_basesoc_soccontroller_bus_errors_status[31:0];
assign basesoc_basesoc_soccontroller_bus_errors_we = builder_csrbank1_bus_errors_we;
assign basesoc_basesoc_soccontroller_bus_errors_re = builder_csrbank1_bus_errors_re;
...
assign builder_csrbank2_dig_00_re = ((builder_csrbank2_sel & builder_interface2_bank_bus_we) & (builder_interface2_bank_bus_adr[2:0] == 1'd0));
assign builder_csrbank2_dig_00_we = ((builder_csrbank2_sel & (~builder_interface2_bank_bus_we)) & (builder_interface2_bank_bus_adr[2:0] == 1'd0));
assign builder_csrbank2_dig_10_r = builder_interface2_bank_bus_dat_w[7:0];
assign builder_csrbank2_dig_10_re = ((builder_csrbank2_sel & builder_interface2_bank_bus_we) & (builder_interface2_bank_bus_adr[2:0] == 1'd1));
assign builder_csrbank2_dig_10_we = ((builder_csrbank2_sel & (~builder_interface2_bank_bus_we)) & (builder_interface2_bank_bus_adr[2:0] == 1'd1));
assign builder_csrbank2_dig_20_r = builder_interface2_bank_bus_dat_w[7:0];
assign builder_csrbank2_dig_20_re = ((builder_csrbank2_sel & builder_interface2_bank_bus_we) & (builder_interface2_bank_bus_adr[2:0] == 2'd2));
assign builder_csrbank2_dig_20_we = ((builder_csrbank2_sel & (~builder_interface2_bank_bus_we)) & (builder_interface2_bank_bus_adr[2:0] == 2'd2));
assign builder_csrbank2_dig_30_r = builder_interface2_bank_bus_dat_w[7:0];
assign builder_csrbank2_dig_30_re = ((builder_csrbank2_sel & builder_interface2_bank_bus_we) & (builder_interface2_bank_bus_adr[2:0] == 2'd3));
assign builder_csrbank2_dig_30_we = ((builder_csrbank2_sel & (~builder_interface2_bank_bus_we)) & (builder_interface2_bank_bus_adr[2:0] == 2'd3));
assign builder_csrbank2_dig_40_r = builder_interface2_bank_bus_dat_w[7:0];
assign builder_csrbank2_dig_40_re = ((builder_csrbank2_sel & builder_interface2_bank_bus_we) & (builder_interface2_bank_bus_adr[2:0] == 3'd4));
assign builder_csrbank2_dig_40_we = ((builder_csrbank2_sel & (~builder_interface2_bank_bus_we)) & (builder_interface2_bank_bus_adr[2:0] == 3'd4));
assign builder_csrbank2_dig_50_r = builder_interface2_bank_bus_dat_w[7:0];
assign builder_csrbank2_dig_50_re = ((builder_csrbank2_sel & builder_interface2_bank_bus_we) & (builder_interface2_bank_bus_adr[2:0] == 3'd5));
assign builder_csrbank2_dig_50_we = ((builder_csrbank2_sel & (~builder_interface2_bank_bus_we)) & (builder_interface2_bank_bus_adr[2:0] == 3'd5));
assign builder_csrbank2_dig_60_r = builder_interface2_bank_bus_dat_w[7:0];
assign builder_csrbank2_dig_60_re = ((builder_csrbank2_sel & builder_interface2_bank_bus_we) & (builder_interface2_bank_bus_adr[2:0] == 3'd6));
assign builder_csrbank2_dig_60_we = ((builder_csrbank2_sel & (~builder_interface2_bank_bus_we)) & (builder_interface2_bank_bus_adr[2:0] == 3'd6));
assign builder_csrbank2_dig_70_r = builder_interface2_bank_bus_dat_w[7:0];
assign builder_csrbank2_dig_70_re = ((builder_csrbank2_sel & builder_interface2_bank_bus_we) & (builder_interface2_bank_bus_adr[2:0] == 3'd7));
assign builder_csrbank2_dig_70_we = ((builder_csrbank2_sel & (~builder_interface2_bank_bus_we)) & (builder_interface2_bank_bus_adr[2:0] == 3'd7));
...
assign builder_csrbank3_sel = (builder_interface3_bank_bus_adr[13:9] == 4'd12);
assign builder_csrbank3_distancia_r = builder_interface3_bank_bus_dat_w[7:0];
assign builder_csrbank3_distancia_re = ((builder_csrbank3_sel & builder_interface3_bank_bus_we) & (builder_interface3_bank_bus_adr[0] == 1'd0));
assign builder_csrbank3_distancia_we = ((builder_csrbank3_sel & (~builder_interface3_bank_bus_we)) & (builder_interface3_bank_bus_adr[0] == 1'd0));
assign builder_csrbank3_distancia_w = basesoc_infrarrojo_cntrl_status[7:0];
assign basesoc_infrarrojo_cntrl_we = builder_csrbank3_distancia_we;
assign basesoc_infrarrojo_cntrl_re = builder_csrbank3_distancia_re;
...
assign builder_csrbank7_sel = (builder_interface7_bank_bus_adr[13:9] == 4'd13);
assign builder_csrbank7_orden0_r = builder_interface7_bank_bus_dat_w[2:0];
assign builder_csrbank7_orden0_re = ((builder_csrbank7_sel & builder_interface7_bank_bus_we) & (builder_interface7_bank_bus_adr[0] == 1'd0));
assign builder_csrbank7_orden0_we = ((builder_csrbank7_sel & (~builder_interface7_bank_bus_we)) & (builder_interface7_bank_bus_adr[0] == 1'd0));
assign builder_csrbank7_orden0_w = basesoc_pwm_cntrl_storage[2:0];
assign builder_csrbank8_sel = (builder_interface8_bank_bus_adr[13:9] == 3'd6);
assign builder_csrbank8_in_r = builder_interface8_bank_bus_dat_w[7:0];
assign builder_csrbank8_in_re = ((builder_csrbank8_sel & builder_interface8_bank_bus_we) & (builder_interface8_bank_bus_adr[0] == 1'd0));
assign builder_csrbank8_in_we = ((builder_csrbank8_sel & (~builder_interface8_bank_bus_we)) & (builder_interface8_bank_bus_adr[0] == 1'd0));
assign builder_csrbank8_in_w = basesoc_switchs_status[7:0];
assign basesoc_switchs_we = builder_csrbank8_in_we;
assign basesoc_switchs_re = builder_csrbank8_in_re;
assign builder_csrbank9_sel = (builder_interface9_bank_bus_adr[13:9] == 3'd4);
assign builder_csrbank9_load0_r = builder_interface9_bank_bus_dat_w[31:0];
assign builder_csrbank9_load0_re = ((builder_csrbank9_sel & builder_interface9_bank_bus_we) & (builder_interface9_bank_bus_adr[2:0] == 1'd0));
assign builder_csrbank9_load0_we = ((builder_csrbank9_sel & (~builder_interface9_bank_bus_we)) & (builder_interface9_bank_bus_adr[2:0] == 1'd0));
assign builder_csrbank9_reload0_r = builder_interface9_bank_bus_dat_w[31:0];
assign builder_csrbank9_reload0_re = ((builder_csrbank9_sel & builder_interface9_bank_bus_we) & (builder_interface9_bank_bus_adr[2:0] == 1'd1));
assign builder_csrbank9_reload0_we = ((builder_csrbank9_sel & (~builder_interface9_bank_bus_we)) & (builder_interface9_bank_bus_adr[2:0] == 1'd1));
assign builder_csrbank9_en0_r = builder_interface9_bank_bus_dat_w[0];
assign builder_csrbank9_en0_re = ((builder_csrbank9_sel & builder_interface9_bank_bus_we) & (builder_interface9_bank_bus_adr[2:0] == 2'd2));
assign builder_csrbank9_en0_we = ((builder_csrbank9_sel & (~builder_interface9_bank_bus_we)) & (builder_interface9_bank_bus_adr[2:0] == 2'd2));
assign builder_csrbank9_update_value0_r = builder_interface9_bank_bus_dat_w[0];
assign builder_csrbank9_update_value0_re = ((builder_csrbank9_sel & builder_interface9_bank_bus_we) & (builder_interface9_bank_bus_adr[2:0] == 2'd3));
assign builder_csrbank9_update_value0_we = ((builder_csrbank9_sel & (~builder_interface9_bank_bus_we)) & (builder_interface9_bank_bus_adr[2:0] == 2'd3));
assign builder_csrbank9_value_r = builder_interface9_bank_bus_dat_w[31:0];
assign builder_csrbank9_value_re = ((builder_csrbank9_sel & builder_interface9_bank_bus_we) & (builder_interface9_bank_bus_adr[2:0] == 3'd4));
assign builder_csrbank9_value_we = ((builder_csrbank9_sel & (~builder_interface9_bank_bus_we)) & (builder_interface9_bank_bus_adr[2:0] == 3'd4));
assign basesoc_basesoc_timer_eventmanager_status_r = builder_interface9_bank_bus_dat_w[0];
assign basesoc_basesoc_timer_eventmanager_status_re = ((builder_csrbank9_sel & builder_interface9_bank_bus_we) & (builder_interface9_bank_bus_adr[2:0] == 3'd5));
assign basesoc_basesoc_timer_eventmanager_status_we = ((builder_csrbank9_sel & (~builder_interface9_bank_bus_we)) & (builder_interface9_bank_bus_adr[2:0] == 3'd5));
assign basesoc_basesoc_timer_eventmanager_pending_r = builder_interface9_bank_bus_dat_w[0];
assign basesoc_basesoc_timer_eventmanager_pending_re = ((builder_csrbank9_sel & builder_interface9_bank_bus_we) & (builder_interface9_bank_bus_adr[2:0] == 3'd6));
assign basesoc_basesoc_timer_eventmanager_pending_we = ((builder_csrbank9_sel & (~builder_interface9_bank_bus_we)) & (builder_interface9_bank_bus_adr[2:0] == 3'd6));
assign builder_csrbank9_ev_enable0_r = builder_interface9_bank_bus_dat_w[0];
assign builder_csrbank9_ev_enable0_re = ((builder_csrbank9_sel & builder_interface9_bank_bus_we) & (builder_interface9_bank_bus_adr[2:0] == 3'd7));
assign builder_csrbank9_ev_enable0_we = ((builder_csrbank9_sel & (~builder_interface9_bank_bus_we)) & (builder_interface9_bank_bus_adr[2:0] == 3'd7));
...
assign basesoc_basesoc_timer_value_re = builder_csrbank9_value_re;
assign builder_csrbank9_ev_enable0_w = basesoc_basesoc_timer_eventmanager_storage;
assign builder_csrbank10_sel = (builder_interface10_bank_bus_adr[13:9] == 2'd3);
assign basesoc_basesoc_uart_rxtx_r = builder_interface10_bank_bus_dat_w[7:0];
assign basesoc_basesoc_uart_rxtx_re = ((builder_csrbank10_sel & builder_interface10_bank_bus_we) & (builder_interface10_bank_bus_adr[2:0] == 1'd0));
assign basesoc_basesoc_uart_rxtx_we = ((builder_csrbank10_sel & (~builder_interface10_bank_bus_we)) & (builder_interface10_bank_bus_adr[2:0] == 1'd0));
...
assign basesoc_basesoc_uart_eventmanager_status_r = builder_interface10_bank_bus_dat_w[1:0];
assign basesoc_basesoc_uart_eventmanager_status_re = ((builder_csrbank10_sel & builder_interface10_bank_bus_we) & (builder_interface10_bank_bus_adr[2:0] == 2'd3));
assign basesoc_basesoc_uart_eventmanager_status_we = ((builder_csrbank10_sel & (~builder_interface10_bank_bus_we)) & (builder_interface10_bank_bus_adr[2:0] == 2'd3));
assign basesoc_basesoc_uart_eventmanager_pending_r = builder_interface10_bank_bus_dat_w[1:0];
assign basesoc_basesoc_uart_eventmanager_pending_re = ((builder_csrbank10_sel & builder_interface10_bank_bus_we) & (builder_interface10_bank_bus_adr[2:0] == 3'd4));
assign basesoc_basesoc_uart_eventmanager_pending_we = ((builder_csrbank10_sel & (~builder_interface10_bank_bus_we)) & (builder_interface10_bank_bus_adr[2:0] == 3'd4));
...
assign basesoc_basesoc_uart_txfull_re = builder_csrbank10_txfull_re;
...
assign basesoc_basesoc_uart_rxempty_re = builder_csrbank10_rxempty_re;
assign builder_csrbank10_ev_enable0_w = basesoc_basesoc_uart_eventmanager_storage[1:0];
...
assign basesoc_basesoc_uart_txempty_re = builder_csrbank10_txempty_re;
...
assign basesoc_basesoc_uart_rxfull_re = builder_csrbank10_rxfull_re;
assign builder_csrbank11_sel = (builder_interface11_bank_bus_adr[13:9] == 5'd16);
assign basesoc_rxtx_r = builder_interface11_bank_bus_dat_w[7:0];
assign basesoc_rxtx_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[2:0] == 1'd0));
assign basesoc_rxtx_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[2:0] == 1'd0));
assign builder_csrbank11_txfull_r = builder_interface11_bank_bus_dat_w[0];
assign builder_csrbank11_txfull_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[2:0] == 1'd1));
assign builder_csrbank11_txfull_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[2:0] == 1'd1));
assign builder_csrbank11_rxempty_r = builder_interface11_bank_bus_dat_w[0];
assign builder_csrbank11_rxempty_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[2:0] == 2'd2));
assign builder_csrbank11_rxempty_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[2:0] == 2'd2));
assign basesoc_eventmanager_status_r = builder_interface11_bank_bus_dat_w[1:0];
assign basesoc_eventmanager_status_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[2:0] == 2'd3));
assign basesoc_eventmanager_status_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[2:0] == 2'd3));
assign basesoc_eventmanager_pending_r = builder_interface11_bank_bus_dat_w[1:0];
assign basesoc_eventmanager_pending_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[2:0] == 3'd4));
assign basesoc_eventmanager_pending_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[2:0] == 3'd4));
assign builder_csrbank11_ev_enable0_r = builder_interface11_bank_bus_dat_w[1:0];
assign builder_csrbank11_ev_enable0_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[2:0] == 3'd5));
assign builder_csrbank11_ev_enable0_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[2:0] == 3'd5));
assign builder_csrbank11_txempty_r = builder_interface11_bank_bus_dat_w[0];
assign builder_csrbank11_txempty_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[2:0] == 3'd6));
assign builder_csrbank11_txempty_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[2:0] == 3'd6));
assign builder_csrbank11_rxfull_r = builder_interface11_bank_bus_dat_w[0];
assign builder_csrbank11_rxfull_re = ((builder_csrbank11_sel & builder_interface11_bank_bus_we) & (builder_interface11_bank_bus_adr[2:0] == 3'd7));
assign builder_csrbank11_rxfull_we = ((builder_csrbank11_sel & (~builder_interface11_bank_bus_we)) & (builder_interface11_bank_bus_adr[2:0] == 3'd7));
assign builder_csrbank11_txfull_w = basesoc_txfull_status;
assign basesoc_txfull_we = builder_csrbank11_txfull_we;
assign basesoc_txfull_re = builder_csrbank11_txfull_re;
assign builder_csrbank11_rxempty_w = basesoc_rxempty_status;
assign basesoc_rxempty_we = builder_csrbank11_rxempty_we;
assign basesoc_rxempty_re = builder_csrbank11_rxempty_re;
assign builder_csrbank11_ev_enable0_w = basesoc_eventmanager_storage[1:0];
assign builder_csrbank11_txempty_w = basesoc_txempty_status;
assign basesoc_txempty_we = builder_csrbank11_txempty_we;
assign basesoc_txempty_re = builder_csrbank11_txempty_re;
assign builder_csrbank11_rxfull_w = basesoc_rxfull_status;
assign basesoc_rxfull_we = builder_csrbank11_rxfull_we;
assign basesoc_rxfull_re = builder_csrbank11_rxfull_re;
assign builder_csrbank12_sel = (builder_interface12_bank_bus_adr[13:9] == 4'd15);
...
assign builder_csrbank12_tuning_word0_w = basesoc_uart1_phy_storage[31:0];
assign builder_csrbank13_sel = (builder_interface13_bank_bus_adr[13:9] == 2'd2);
assign builder_csrbank13_tuning_word0_r = builder_interface13_bank_bus_dat_w[31:0];
assign builder_csrbank13_tuning_word0_re = ((builder_csrbank13_sel & builder_interface13_bank_bus_we) & (builder_interface13_bank_bus_adr[0] == 1'd0));
assign builder_csrbank13_tuning_word0_we = ((builder_csrbank13_sel & (~builder_interface13_bank_bus_we)) & (builder_interface13_bank_bus_adr[0] == 1'd0));
assign builder_csrbank13_tuning_word0_w = basesoc_basesoc_storage[31:0];
assign builder_csrbank14_sel = (builder_interface14_bank_bus_adr[13:9] == 4'd14);
assign builder_csrbank14_orden0_r = builder_interface14_bank_bus_dat_w[0];
assign builder_csrbank14_orden0_re = ((builder_csrbank14_sel & builder_interface14_bank_bus_we) & (builder_interface14_bank_bus_adr[1:0] == 1'd0));
assign builder_csrbank14_orden0_we = ((builder_csrbank14_sel & (~builder_interface14_bank_bus_we)) & (builder_interface14_bank_bus_adr[1:0] == 1'd0));
assign builder_csrbank14_done_r = builder_interface14_bank_bus_dat_w[0];
assign builder_csrbank14_done_re = ((builder_csrbank14_sel & builder_interface14_bank_bus_we) & (builder_interface14_bank_bus_adr[1:0] == 1'd1));
assign builder_csrbank14_done_we = ((builder_csrbank14_sel & (~builder_interface14_bank_bus_we)) & (builder_interface14_bank_bus_adr[1:0] == 1'd1));
assign builder_csrbank14_d_r = builder_interface14_bank_bus_dat_w[7:0];
assign builder_csrbank14_d_re = ((builder_csrbank14_sel & builder_interface14_bank_bus_we) & (builder_interface14_bank_bus_adr[1:0] == 2'd2));
assign builder_csrbank14_d_we = ((builder_csrbank14_sel & (~builder_interface14_bank_bus_we)) & (builder_interface14_bank_bus_adr[1:0] == 2'd2));
assign builder_csrbank14_orden0_w = basesoc_orden_storage;
assign builder_csrbank14_done_w = basesoc_done_status;
assign basesoc_done_we = builder_csrbank14_done_we;
assign basesoc_done_re = builder_csrbank14_done_re;
assign builder_csrbank14_d_w = basesoc_d_status[7:0];
assign basesoc_d_we = builder_csrbank14_d_we;
assign basesoc_d_re = builder_csrbank14_d_re;
assign builder_csrbank15_sel = (builder_interface15_bank_bus_adr[13:9] == 4'd11);
assign builder_csrbank15_mem_adr0_r = builder_interface15_bank_bus_dat_w[18:0];
assign builder_csrbank15_mem_adr0_re = ((builder_csrbank15_sel & builder_interface15_bank_bus_we) & (builder_interface15_bank_bus_adr[1:0] == 1'd0));
assign builder_csrbank15_mem_adr0_we = ((builder_csrbank15_sel & (~builder_interface15_bank_bus_we)) & (builder_interface15_bank_bus_adr[1:0] == 1'd0));
assign builder_csrbank15_mem_we0_r = builder_interface15_bank_bus_dat_w[0];
assign builder_csrbank15_mem_we0_re = ((builder_csrbank15_sel & builder_interface15_bank_bus_we) & (builder_interface15_bank_bus_adr[1:0] == 1'd1));
assign builder_csrbank15_mem_we0_we = ((builder_csrbank15_sel & (~builder_interface15_bank_bus_we)) & (builder_interface15_bank_bus_adr[1:0] == 1'd1));
assign builder_csrbank15_mem_data_w0_r = builder_interface15_bank_bus_dat_w[11:0];
assign builder_csrbank15_mem_data_w0_re = ((builder_csrbank15_sel & builder_interface15_bank_bus_we) & (builder_interface15_bank_bus_adr[1:0] == 2'd2));
assign builder_csrbank15_mem_data_w0_we = ((builder_csrbank15_sel & (~builder_interface15_bank_bus_we)) & (builder_interface15_bank_bus_adr[1:0] == 2'd2));
assign builder_csrbank15_mem_data_r_r = builder_interface15_bank_bus_dat_w[11:0];
assign builder_csrbank15_mem_data_r_re = ((builder_csrbank15_sel & builder_interface15_bank_bus_we) & (builder_interface15_bank_bus_adr[1:0] == 2'd3));
assign builder_csrbank15_mem_data_r_we = ((builder_csrbank15_sel & (~builder_interface15_bank_bus_we)) & (builder_interface15_bank_bus_adr[1:0] == 2'd3));
...
assign basesoc_mem_data_r_re = builder_csrbank15_mem_data_r_re;
...
always @(posedge sys_clk) begin
	...
	basesoc_tx_old_trigger <= basesoc_tx_trigger;
	if (((~basesoc_tx_trigger) & basesoc_tx_old_trigger)) begin
		basesoc_tx_pending <= 1'd1;
	end
	if (basesoc_rx_clear) begin
		basesoc_rx_pending <= 1'd0;
	end
	basesoc_rx_old_trigger <= basesoc_rx_trigger;
	if (((~basesoc_rx_trigger) & basesoc_rx_old_trigger)) begin
	...
	if (basesoc_reset) begin
		basesoc_tx_pending <= 1'd0;
		basesoc_tx_old_trigger <= 1'd0;
		basesoc_rx_pending <= 1'd0;
		basesoc_rx_old_trigger <= 1'd0;
		basesoc_tx_fifo_readable <= 1'd0;
	...
	if (builder_csrbank1_reset0_re) begin
		basesoc_basesoc_soccontroller_reset_storage <= builder_csrbank1_reset0_r;
	end
	basesoc_basesoc_soccontroller_reset_re <= builder_csrbank1_reset0_re;
	if (builder_csrbank1_scratch0_re) begin
		basesoc_basesoc_soccontroller_scratch_storage[31:0] <= builder_csrbank1_scratch0_r;
	end
	basesoc_basesoc_soccontroller_scratch_re <= builder_csrbank1_scratch0_re;
	builder_interface2_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank2_sel) begin
		case (builder_interface2_bank_bus_adr[2:0])
			1'd0: begin
	...
	if (builder_csrbank3_sel) begin
		case (builder_interface3_bank_bus_adr[0])
			1'd0: begin
				builder_interface3_bank_bus_dat_r <= builder_csrbank3_distancia_w;
			end
		endcase
	end
	...
	if (builder_csrbank7_sel) begin
		case (builder_interface7_bank_bus_adr[0])
			1'd0: begin
				builder_interface7_bank_bus_dat_r <= builder_csrbank7_orden0_w;
			end
		endcase
	end
	if (builder_csrbank7_orden0_re) begin
		basesoc_pwm_cntrl_storage[2:0] <= builder_csrbank7_orden0_r;
	end
	basesoc_pwm_cntrl_re <= builder_csrbank7_orden0_re;
	builder_interface8_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank8_sel) begin
		case (builder_interface8_bank_bus_adr[0])
			1'd0: begin
	...
	if (builder_csrbank9_sel) begin
		case (builder_interface9_bank_bus_adr[2:0])
			...
			3'd5: begin
				builder_interface9_bank_bus_dat_r <= basesoc_basesoc_timer_eventmanager_status_w;
			end
			3'd6: begin
				builder_interface9_bank_bus_dat_r <= basesoc_basesoc_timer_eventmanager_pending_w;
			end
			3'd7: begin
	...
	if (builder_csrbank9_ev_enable0_re) begin
		basesoc_basesoc_timer_eventmanager_storage <= builder_csrbank9_ev_enable0_r;
	end
	basesoc_basesoc_timer_eventmanager_re <= builder_csrbank9_ev_enable0_re;
	...
	if (builder_csrbank10_sel) begin
		case (builder_interface10_bank_bus_adr[2:0])
			...
			2'd3: begin
				builder_interface10_bank_bus_dat_r <= basesoc_basesoc_uart_eventmanager_status_w;
			end
			3'd4: begin
				builder_interface10_bank_bus_dat_r <= basesoc_basesoc_uart_eventmanager_pending_w;
			end
			3'd5: begin
	...
	if (builder_csrbank10_ev_enable0_re) begin
		basesoc_basesoc_uart_eventmanager_storage[1:0] <= builder_csrbank10_ev_enable0_r;
	end
	basesoc_basesoc_uart_eventmanager_re <= builder_csrbank10_ev_enable0_re;
	builder_interface11_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank11_sel) begin
		case (builder_interface11_bank_bus_adr[2:0])
			1'd0: begin
			...
			2'd3: begin
				builder_interface11_bank_bus_dat_r <= basesoc_eventmanager_status_w;
			end
			3'd4: begin
				builder_interface11_bank_bus_dat_r <= basesoc_eventmanager_pending_w;
			end
			3'd5: begin
	...
	if (builder_csrbank11_ev_enable0_re) begin
		basesoc_eventmanager_storage[1:0] <= builder_csrbank11_ev_enable0_r;
	end
	basesoc_eventmanager_re <= builder_csrbank11_ev_enable0_re;
	...
	if (builder_csrbank12_tuning_word0_re) begin
		basesoc_uart1_phy_storage[31:0] <= builder_csrbank12_tuning_word0_r;
	end
	basesoc_uart1_phy_re <= builder_csrbank12_tuning_word0_re;
	builder_interface13_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank13_sel) begin
		case (builder_interface13_bank_bus_adr[0])
			1'd0: begin
				builder_interface13_bank_bus_dat_r <= builder_csrbank13_tuning_word0_w;
			end
		endcase
	end
	if (builder_csrbank13_tuning_word0_re) begin
		basesoc_basesoc_storage[31:0] <= builder_csrbank13_tuning_word0_r;
	end
	basesoc_basesoc_re <= builder_csrbank13_tuning_word0_re;
	builder_interface14_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank14_sel) begin
		case (builder_interface14_bank_bus_adr[1:0])
			1'd0: begin
				builder_interface14_bank_bus_dat_r <= builder_csrbank14_orden0_w;
			end
			1'd1: begin
				builder_interface14_bank_bus_dat_r <= builder_csrbank14_done_w;
			end
			2'd2: begin
				builder_interface14_bank_bus_dat_r <= builder_csrbank14_d_w;
			end
		endcase
	end
	if (builder_csrbank14_orden0_re) begin
		basesoc_orden_storage <= builder_csrbank14_orden0_r;
	end
	basesoc_orden_re <= builder_csrbank14_orden0_re;
	builder_interface15_bank_bus_dat_r <= 1'd0;
	if (builder_csrbank15_sel) begin
		case (builder_interface15_bank_bus_adr[1:0])
			1'd0: begin
	...
	if (sys_rst) begin
		...
		basesoc_pwm_cntrl_storage <= 3'd0;
		basesoc_pwm_cntrl_re <= 1'd0;
		basesoc_orden_storage <= 1'd0;
		basesoc_orden_re <= 1'd0;
		uart1_tx <= 1'd1;
		basesoc_uart1_phy_storage <= 32'd412316;
		...
		basesoc_rx_pending <= 1'd0;
		basesoc_rx_old_trigger <= 1'd0;
		basesoc_eventmanager_storage <= 2'd0;
...
modulo_ir modulo_ir(
	...
	.rst(sys_rst),
	.ir_io(ir_inout),
	.distancia(basesoc_infrarrojo_cntrl_status)
);

BloquePWM BloquePWM(
	.clk(sys_clk),
	.orden(basesoc_pwm_cntrl_storage),
	.pwm(pwm_out)
);
...
bloqueultrasonido bloqueultrasonido(
	.clk(sys_clk),
	.echo(us_echo),
	.orden(basesoc_orden_storage),
	.rst(sys_rst),
	.d(basesoc_d_status),
	.done(basesoc_done_status),
	.trigger(us_trigger)
);
...
always @(posedge sys_clk) begin
	...
	memdat_5 <= storage_2[basesoc_tx_fifo_wrport_adr];
end

always @(posedge sys_clk) begin
	if (basesoc_tx_fifo_rdport_re)
		memdat_6 <= storage_2[basesoc_tx_fifo_rdport_adr];
end

assign basesoc_tx_fifo_wrport_dat_r = memdat_5;
assign basesoc_tx_fifo_rdport_dat_r = memdat_6;
...
always @(posedge sys_clk) begin
	...
	memdat_7 <= storage_3[basesoc_rx_fifo_wrport_adr];
end

always @(posedge sys_clk) begin
	if (basesoc_rx_fifo_rdport_re)
		memdat_8 <= storage_3[basesoc_rx_fifo_rdport_adr];
end

assign basesoc_rx_fifo_wrport_dat_r = memdat_7;
assign basesoc_rx_fifo_rdport_dat_r = memdat_8;
