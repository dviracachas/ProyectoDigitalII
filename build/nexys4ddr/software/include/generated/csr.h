//--------------------------------------------------------------------------------
// Auto-generated by Migen (a5cc037) & LiteX (5097b7ae) on 2020-12-11 20:15:00
//--------------------------------------------------------------------------------
...
/* infrarrojo_cntrl */
#define CSR_INFRARROJO_CNTRL_BASE (CSR_BASE + 0x6800L)
#define CSR_INFRARROJO_CNTRL_DISTANCIA_ADDR (CSR_BASE + 0x6800L)
...
#define CSR_INFRARROJO_CNTRL_EV_STATUS_ADDR (CSR_BASE + 0x6804L)
#define CSR_INFRARROJO_CNTRL_EV_STATUS_SIZE 1
static inline uint32_t infrarrojo_cntrl_ev_status_read(void) {
	return csr_read_simple(CSR_BASE + 0x6804L);
}
static inline void infrarrojo_cntrl_ev_status_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x6804L);
}
#define CSR_INFRARROJO_CNTRL_EV_PENDING_ADDR (CSR_BASE + 0x6808L)
#define CSR_INFRARROJO_CNTRL_EV_PENDING_SIZE 1
static inline uint32_t infrarrojo_cntrl_ev_pending_read(void) {
	return csr_read_simple(CSR_BASE + 0x6808L);
}
static inline void infrarrojo_cntrl_ev_pending_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x6808L);
}
#define CSR_INFRARROJO_CNTRL_EV_ENABLE_ADDR (CSR_BASE + 0x680cL)
#define CSR_INFRARROJO_CNTRL_EV_ENABLE_SIZE 1
static inline uint32_t infrarrojo_cntrl_ev_enable_read(void) {
	return csr_read_simple(CSR_BASE + 0x680cL);
}
static inline void infrarrojo_cntrl_ev_enable_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x680cL);
}

/* pwm_cntrl */
#define CSR_PWM_CNTRL_BASE (CSR_BASE + 0x7000L)
#define CSR_PWM_CNTRL_ORDEN_ADDR (CSR_BASE + 0x7000L)
