...
/* infrarrojo_cntrl */
#define CSR_INFRARROJO_CNTRL_BASE (CSR_BASE + 0x6000L)
#define CSR_INFRARROJO_CNTRL_DISTANCIA_ADDR (CSR_BASE + 0x6000L)
#define CSR_INFRARROJO_CNTRL_DISTANCIA_SIZE 1
static inline uint32_t infrarrojo_cntrl_distancia_read(void) {
	return csr_read_simple(CSR_BASE + 0x6000L);
}

/* pwm_cntrl */
#define CSR_PWM_CNTRL_BASE (CSR_BASE + 0x6800L)
#define CSR_PWM_CNTRL_ORDEN_ADDR (CSR_BASE + 0x6800L)
...
/* ultrasonido */
#define CSR_ULTRASONIDO_BASE (CSR_BASE + 0x7000L)
#define CSR_ULTRASONIDO_ORDEN_ADDR (CSR_BASE + 0x7000L)
#define CSR_ULTRASONIDO_ORDEN_SIZE 1
static inline uint32_t ultrasonido_orden_read(void) {
	return csr_read_simple(CSR_BASE + 0x7000L);
}
static inline void ultrasonido_orden_write(uint32_t v) {
	csr_write_simple(v, CSR_BASE + 0x7000L);
}
#define CSR_ULTRASONIDO_DONE_ADDR (CSR_BASE + 0x7004L)
...
#define CSR_ULTRASONIDO_D_ADDR (CSR_BASE + 0x7008L)
#define CSR_ULTRASONIDO_D_SIZE 1
static inline uint32_t ultrasonido_d_read(void) {
	return csr_read_simple(CSR_BASE + 0x7008L);
}

/* uart1_phy */
#define CSR_UART1_PHY_BASE (CSR_BASE + 0x7800L)
#define CSR_UART1_PHY_TUNING_WORD_ADDR (CSR_BASE + 0x7800L)
...
/* uart1 */
#define CSR_UART1_BASE (CSR_BASE + 0x8000L)
#define CSR_UART1_RXTX_ADDR (CSR_BASE + 0x8000L)
...
#define CSR_UART1_EV_PENDING_ADDR (CSR_BASE + 0x8010L)
...
#define CSR_UART1_EV_ENABLE_ADDR (CSR_BASE + 0x8014L)
